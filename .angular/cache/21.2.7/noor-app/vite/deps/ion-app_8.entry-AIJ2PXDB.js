...
import {
  transition
} from "./chunk-CWQRDXMK.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-S2LTAWOG.js";
import {
  createColorClasses,
  hostContext
  ...
  componentDidLoad() {
    {
      this.rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BtUdxPjv-IPD3IAIG.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-BfJqFSLF-FBO4QE6Y.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-AaDhOpKN-LY4KQSJH.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = await import("./hardware-back-button-CTe4XmL7-AJVBVJBU.js");
...
var RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import("./swipe-back-BZBFwTQV-AULKWNFI.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
      var _a;
...
//# sourceMappingURL=ion-app_8.entry-AIJ2PXDB.js.map
