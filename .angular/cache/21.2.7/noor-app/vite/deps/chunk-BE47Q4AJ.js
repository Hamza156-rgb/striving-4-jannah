...
var p3 = (() => {
  const s6 = /* @__PURE__ */ new Map(), a5 = [], o8 = async (t5, e5 = false) => {
    if (await d2(), "start" === t5 || "end" === t5) {
  ...
  return f4("reveal", c6), f4("push", u4), f4("overlay", i3), null == o2 || o2.addEventListener("ionBackButton", ((t5) => {
  ...
  })), { registerAnimation: f4, get: o8, getMenus: async () => (await d2(), a5.map(((t5) => t5.el))), getOpen: p4, isEnabled: async (t5) => {
    const e5 = await o8(t5);
    return !!e5 && !e5.disabled;
  }, swipeGesture: async (t5, e5) => {
    const n4 = await o8(e5);
    return n4 && (n4.swipeGesture = t5), n4;
  }, isAnimating: async () => (await d2(), l7()), isOpen: async (t5) => {
    if (null != t5) {
      const e5 = await o8(t5);
    ...
    const e5 = await o8(t5, true);
    return !!e5 && e5.toggle();
  }, close: async (t5) => {
    const e5 = await (void 0 !== t5 ? o8(t5, true) : p4());
    ...
    e5 > -1 && a5.splice(e5, 1);
  }, _setOpen: async (t5, e5, n4, r5) => {
    if (l7()) return false;
    if (e5) {
      const e6 = await p4();
      e6 && t5.el !== e6 && await e6.setOpen(false, false);
    }
...
var o6 = async (o8, t5, i6, n4, r5, s6) => {
  var a5;
  ...
  return n4 && n4.forEach(((e5) => c8.classList.add(e5))), r5 && Object.assign(c8, r5), t5.appendChild(c8), await new Promise(((o9) => e2(c8, o9))), c8;
};
var t3 = (e5, o8) => {
  if (o8) {
...
var i4 = () => {
  let o8, t5;
  return { attachViewToDom: async (i6, n4, r5 = {}, s6 = []) => {
    var a5, c8;
    let l7;
    if (o8 = i6, n4) {
      const t6 = "string" == typeof n4 ? null === (a5 = o8.ownerDocument) || void 0 === a5 ? void 0 : a5.createElement(n4) : n4;
      s6.forEach(((e5) => t6.classList.add(e5))), Object.assign(t6, r5), o8.appendChild(t6), l7 = t6, await new Promise(((o9) => e2(t6, o9)));
...
var T = (n4) => ({ create: (o8) => S(n4, o8), dismiss: (o8, e5, t5) => E(document, o8, e5, n4, t5), getTop: async () => V(document, n4) });
var x = T("ion-alert");
...
var $ = async (n4, o8, e5, t5, i6) => {
  ...
  await R(n4, m2, n4.el, i6) && (n4.didPresent.emit(), null === (r5 = n4.didPresentShorthand) || void 0 === r5 || r5.emit()), !n4.keyboardClose || null !== document.activeElement && n4.el.contains(document.activeElement) || n4.el.focus(), n4.el.removeAttribute("aria-hidden"), n4.el.removeAttribute("inert");
};
var G = async (n4) => {
  ...
  e5 && (o8 = e5.querySelector(v2) || o8), await n4.onDidDismiss(), null !== document.activeElement && document.activeElement !== document.body || o8.focus();
};
var J = async (o8, e5, t5, i6, a5, r5, d2) => {
  var c8, m2;
  ...
  try {
    ...
    t5 !== K && await R(o8, l7, o8.el, d2), o8.didDismiss.emit({ data: e5, role: t5 }), null === (m2 = o8.didDismissShorthand) || void 0 === m2 || m2.emit({ data: e5, role: t5 }), (g2.get(o8) || []).forEach(((n5) => n5.destroy())), g2.delete(o8), o8.el.classList.add("overlay-hidden"), o8.el.style.removeProperty("pointer-events"), void 0 !== o8.el.lastFocus && (o8.el.lastFocus = void 0);
  } catch (n4) {
...
var R = async (n4, o8, e5, t5) => {
  ...
  const a5 = g2.get(n4) || [];
  return g2.set(n4, [...a5, i6]), await i6.play(), true;
};
var q = (n4, o8) => {
  let e5;
...
var X = (n4) => {
  ...
  return { attachViewToDom: async (o9) => {
    const { delegate: e6 } = i6(true);
    if (e6) return await e6.attachViewToDom(n4.el, o9);
...
//# sourceMappingURL=chunk-BE47Q4AJ.js.map
